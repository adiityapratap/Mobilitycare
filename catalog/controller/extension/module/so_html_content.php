	...
	public function index($setting) {
		if (isset($setting['module_description'][$this->config->get('config_language_id')])) {
			...
			if ($setting['show_countdown']) {
				$this->document->addScript('catalog/view/javascript/so_html_content/js/script.js');
				$this->document->addStyle('catalog/view/javascript/so_html_content/css/style.css');
