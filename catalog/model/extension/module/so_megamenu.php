    ...
    public function getSubmenu($id) {
		...
		foreach ($query->rows as $row) {
			...
			if(isset($content['image']['link']) && $content['image']['link']) {
                ...
                $images['link'] = '<img class="lazyload" data-sizes="auto" src="image/loading.svg" data-src="'.$link.'" alt="" style="width: 100%;">';
    ...
    public function getCategories($array = array()) {
		...
		if (is_array($array['categories'])){
	        ...
	        for ($i = 0; $i < count($array['categories']);) {
	            ...
	            $output .= '<div class="mega-menu row">';
	            ...
	            for (; $i < $j; $i++) {
	                if(isset($array['categories'][$i]['id'])) {
                        ...
                        if(is_array($info_category)) {
                           $output .= "<div class='col-md-3 " . $info_category['name'] . "'>";
