		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'accept_language'         => $order_query->row['accept_language'],
			      ...
			      'ndis_full_name'            => $order_query->row['ndis_full_name'],
	'ndis_participant_number'   => $order_query->row['ndis_participant_number'],
	'ndis_dob'                  => $order_query->row['ndis_dob'],
	'ndis_email'                => $order_query->row['ndis_email'],
	'ndis_phone'                => $order_query->row['ndis_phone'],
	'ndis_requestor'            => $order_query->row['ndis_requestor'],
	'ndis_plan_type'            => $order_query->row['ndis_plan_type'],
	'ndis_plan_start_date'      => $order_query->row['ndis_plan_start_date'],
	'ndis_plan_end_date'        => $order_query->row['ndis_plan_end_date'],
	'ndis_plan_manager_name'    => $order_query->row['ndis_plan_manager_name'],
	'ndis_plan_manager_email'   => $order_query->row['ndis_plan_manager_email'],
	'ndis_plan_manager_phone'   => $order_query->row['ndis_plan_manager_phone'],
	'ndis_additional_notes'     => $order_query->row['ndis_additional_notes'],
	'ndis_consent_accuracy'     => $order_query->row['ndis_consent_accuracy'],
	'ndis_consent_processing'   => $order_query->row['ndis_consent_processing'],
