...
При совпадении импортируемых комбинаций связанных опций товаров с существующими, существующие комбинации будут заменены.';
...
$_['entry_spec_model_help']                     = 'указывать разные модели для комбинаций связанных опций (указанные модели будут отображаться в корзине и сохраняться в заказе)';
...
$_['entry_spec_sku_help']               = 'указывать разные артикулы (SKU) для комбинаций связанных опций (указанные SKU будут сохраняться в заказах)';
$_['entry_spec_upc']                    = 'UPC';
$_['entry_spec_upc_help']               = 'указывать разные значения UPC для комбинаций связанных опций (указанные значения будут сохраняться в заказах)';
$_['entry_spec_ean']                    = 'EAN';
$_['entry_spec_ean_help']               = 'указывать разные значения EAN для комбинаций связанных опций (указанные значения будут сохраняться в заказах)';
$_['entry_spec_jan']                    = 'JAN';
$_['entry_spec_jan_help']               = 'указывать разные значения JAN для комбинаций связанных опций (указанные значения будут сохраняться в заказах)';
$_['entry_spec_mpn']                    = 'MPN';
$_['entry_spec_mpn_help']               = 'указывать разные значения MPN для комбинаций связанных опций ';
//$_['entry_spec_mpn_help']               = 'указывать разные значения MPN для комбинаций связанных опций (указанные значения будут сохраняться в заказах)';
$_['entry_spec_location']               = 'Расположение';
$_['entry_spec_location_help']          = 'указывать разные расположения для комбинаций связанных опций (указанные расположения будут сохраняться в заказах)';
$_['entry_spec_price']                  = 'Цена';
$_['entry_spec_price_help']             = 'указывать разные цены для комбинаций связанных опций, если цена для набора связанных опций не заполнена - используется обычная цена товара';
...
$_['entry_spec_weight_help']            = 'указывать разные веса для комбинаций связанных опций (будет использоваться при расчете весов товаров в заказах)';
$_['entry_spec_length']                 = 'Длина';
$_['entry_spec_length_help']            = 'указывать разные длины для комбинаций связанных опций (будет использоваться при расчете весов товаров в заказах)';
$_['entry_spec_width']                  = 'Ширина';
$_['entry_spec_width_help']             = 'указывать разные ширины для комбинаций связанных опций (будет использоваться при расчете весов товаров в заказах)';
$_['entry_spec_height']                 = 'Высота';
$_['entry_spec_height_help']            = 'указывать разные высоты для комбинаций связанных опций (будет использоваться при расчете весов товаров в заказах)';
$_['entry_spec_price_discount']         = 'Скидки';
$_['entry_spec_price_discount_help']    = 'указывать разные скидки для комбинаций связанных опций (работает только вместе c включенной функцией \''.$_['entry_spec_price'].'\'), если скидки для набора связанных опций не заполнены - используются обычные скидки товара';
$_['entry_add_discount']                = 'Добавить скидку';
$_['entry_del_discount_title']          = 'Удалить скидку';
$_['entry_spec_price_special']          = 'Акции';
$_['entry_spec_price_special_help']     = 'указывать разные акции для комбинаций связанных опций (работает только вместе c включенной функцией \''.$_['entry_spec_price'].'\'), если акции для набора связанных опций не заполнены - используются обычные акции товара';
...
$_['entry_spec_sort_order']             = 'Сортировка';
$_['entry_spec_sort_order_help']        = 'указывать порядок отображения комбинаций связанных опций';
...
$_['entry_sort_order_by_options']       = 'Сортировать по опциям';
$_['entry_sort_order_by_options_help']  = 'отображать комбинации связанных опций в порядке задаваемом стандартной сортировкой указаной для значений опций ';
...
$_['text_activation']                   = 'Активация';
$_['text_status']                       = 'Статус';
$_['text_domain']                       = 'Сайт';
$_['text_activate_now']                 = 'Активировать сейчас';
$_['text_i_have_opencart_com_order_id'] = 'У меня есть номер заказа';
$_['text_i_have_key']                   = 'У меня есть ключ активации';
$_['text_order_id']                     = 'Номер заказа';
$_['text_key']                          = 'Ключ активации';
$_['button_activate']                   = 'Активировать';
$_['button_change_key']                 = 'Изменить ключ';
$_['text_update_alert']                 = '(доступна новая версия)';
$_['text_update_alert_full']            = 'Новая версия '.$_['module_name'].' доступна';
$_['text_this_is_test_domain']          = 'Это тестовый сайт';
$_['text_this_is_live_domain']          = 'Это основной сайт';
