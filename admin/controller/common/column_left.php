...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['user_token']) && isset($this->session->data['user_token']) && ($this->request->get['user_token'] == $this->session->data['user_token'])) {
			...
			if ($this->user->hasPermission('access', 'dealer/dealer')) {
				$dealers[] = array(
					'name'	   => 'Dealers',
					'href'     => $this->url->link('dealer/dealer', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Demo Requests',
					'icon'	   => 'fa-wheelchair',
					'href'     => $this->url->link('catalog/form_request/demo_request', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Quote Requests',
					'icon'	   => 'fa-pencil',
					'href'     => $this->url->link('catalog/form_request/quote_request', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Product Trial Requests',
					'icon'	   => 'fa-pencil',
					'href'     => $this->url->link('catalog/form_request/productTrialRequests', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Funding Support Eligibility',
					'icon'	   => 'fa-pencil',
					'href'     => $this->url->link('catalog/form_request/fundingSupportRequests', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					...
					'icon'	   => 'fa-cart',
					'href'     => $this->url->link('catalog/form_request/product_inquiry', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			 }
			 ...
			 if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					...
					'icon'	   => 'fa-dollar',
					'href'     => $this->url->link('catalog/form_request/warranty_claims', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			 }
			 	...
			 	if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Place Order Requests',
					'icon'	   => 'fa-wheelchair',
					'href'     => $this->url->link('catalog/form_request/placeorderRequests', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					...
					'icon'	   => 'fa-pencil',
					'href'     => $this->url->link('catalog/form_request/contactUsFormRequests', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Light Drive Enquiry',
					'icon'	   => 'fa-pencil',
					'href'     => $this->url->link('catalog/form_request/LightDriveEnq', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
			...
			if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Autochair Enquiry',
					'icon'	   => 'fa-pencil',
					'href'     => $this->url->link('catalog/form_request/AutochairEnq', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
		...
		if ($this->user->hasPermission('access', 'catalog/form_request')) {
				$demorequests[] = array(
					'name'	   => 'Request Local Dealer Requests',
					'icon'	   => 'fa-pencil',
					'href'     => $this->url->link('catalog/form_request/findDealerForm_request', 'user_token=' . $this->session->data['user_token'], true),
					'children' => array()
				);
			}
