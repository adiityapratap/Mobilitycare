...
require_once (DIR_APPLICATION.'view/template/extension/soconfig/class/so_fieldMobile.php');
...
class ControllerExtensionModuleSoMobile extends Controller {
    ...
    public function index() {
		...
		$this->document->addScript(DIR_SOCONFIG.'asset/js/mobile.js');
		...
		// Check RTL Css
        $this->document->addStyle(DIR_SOCONFIG.'asset/css/mobile.css');
    ...
    public function install(){
		...
		$main_sql = DIR_TEMPLATE.'extension/soconfig/demo/mobile/install.php';
