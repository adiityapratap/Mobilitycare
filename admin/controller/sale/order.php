...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
		...
		$data['ndis_full_name'] = $order_info['ndis_full_name'];
        $data['ndis_participant_number'] = $order_info['ndis_participant_number'];
        $data['ndis_dob'] = $order_info['ndis_dob'];
        $data['ndis_email'] = $order_info['ndis_email'];
        $data['ndis_phone'] = $order_info['ndis_phone'];
        $data['ndis_requestor'] = $order_info['ndis_requestor'];
        $data['ndis_plan_type'] = $order_info['ndis_plan_type'];
        $data['ndis_plan_start_date'] = $order_info['ndis_plan_start_date'];
        $data['ndis_plan_end_date'] = $order_info['ndis_plan_end_date'];
        $data['ndis_plan_manager_name'] = $order_info['ndis_plan_manager_name'];
        $data['ndis_plan_manager_email'] = $order_info['ndis_plan_manager_email'];
        $data['ndis_plan_manager_phone'] = $order_info['ndis_plan_manager_phone'];
        $data['ndis_additional_notes'] = $order_info['ndis_additional_notes'];
        $data['ndis_consent_accuracy'] = $order_info['ndis_consent_accuracy'];
        $data['ndis_consent_processing'] = $order_info['ndis_consent_processing'];
