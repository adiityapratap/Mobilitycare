...
class php_excel extends \liveopencart\lib\v0030\abstracts\xlsx_lib implements \liveopencart\lib\v0030\interfaces\xlsx_lib {
	
	use \liveopencart\lib\v0030\traits\vendor_lib;
	...
	protected function exportSheetsToBrowser($sheets_data, $browser_file_name = '', $sheets_infos = []) {
	...
	protected function exportSheetsToFile($sheets_data, $file_name, $sheets_infos = []) {
